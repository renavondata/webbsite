...
<script type="text/javascript">document.title="The PECS register";</script>

<h2 class="center">The PECS register<br>
...
<a href="PECSpub.asp">article</a> of 8-Oct-09</p>
<h3>The register</h3>
<p>We will periodically (usually monthly) ask the Civil Service Bureau for the 
latest files, and put them online until they get around to doing so themselves. 
We may miss a file if someone is approved and then resigns a post-service 
employment within a month. If you are wondering about the missing case numbers 
in the sequence, we assume that most of these belong to approvals for 
Directorate Civil Servants below grade D4, which are not open to public 
inspection.</p>
...
<p>In response to our request on 7-Oct-09 and a reminder on 7-Nov-09, the CSB 
sent us on 16-Nov-09 the register in a new, tabulated format, which no longer 
shows case numbers, nor does it show the date of the application. Showing a full 
grasp of modern technology, they printed it out and scanned it back in again, so 
...
perform a public service by hosting the older annual reports on our site. 
Here they are:</p>
<table class="numtable center">
	<tr>
		<th style="text-align:left">Report Number</th>
		<th style="text-align:right">Period ended</th>
	</tr>
	<tr>
		<td>1</td>
