...
<script type="text/javascript">document.title="China Unicom Voting Recommendations";</script>

	<div class="summary">The 7th AGM in Project Poll is on 12-May-03, and we now produce our voting recommendations. We urge shareowners to register votes against the general mandate. If China Unicom issues new shares, don't you want your entitlement?</div>

<h2 class="center">China Unicom Voting Recommendations<br>
<span class="headlinedate">28 April 2003</span></h2>
<table class="txtable">
    <tr>
      <td>Company:</td>
      <td>China Unicom Limited</td>
    </tr>
    <tr>
      <td>Stock code:</td>
      <td>0762</td>
    ...
    <tr>
      ...
      <td>
      <a target="_blank" href="http://www.hkexnews.hk/listedco/listconews/sehk/20030402/LTN20030402041.pdf">Click
        here</a></td>
    </tr>
    <tr>
      <td>Voting method:</td>
...
us</a> if you want one.</b> </p>
  <table class="txtable">
    ...
    <tr>
      <td>3.1</td>
      <td>Elect Shan Weijian</td>
      <td>FOR</td>
    </tr>
    <tr>
      <td>3.2</td>
      <td>Re-elect Shi Cuiming</td>
      <td>FOR</td>
    </tr>
    <tr>
      <td>3.3</td>
      <td>Re-elect Ge Lei</td>
      <td>FOR</td>
    </tr>
    <tr>
      <td>3.4</td>
      <td>Re-elect Craig Oliver McCaw</td>
      <td>FOR</td>
    </tr>
    <tr>
      <td>3.5</td>
      <td>Re-elect William Lo Wing Yan</td>
      <td>FOR</td>
    </tr>
    <tr>
      <td>3.6</td>
      <td>Re-elect Ye Fengping</td>
      <td>FOR</td>
    </tr>
    <tr>
      <td>3.7</td>
      <td>Authorise the directors to fix directors' fees</td>
      <td>FOR</td>
    </tr>
    <tr>
      <td>4</td>
