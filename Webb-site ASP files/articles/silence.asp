...
<script type="text/javascript">document.title="Results Delayed";</script>

	<div class="summary">If your newspapers feel thicker than usual today, blame it on the Stock Exchange, which has yet to implement proposals released in Dec-98, to shorten the reporting deadlines and increase the financial disclosure on the main board. GEM will have quarterly reports and shorter deadlines, but these reports will continue to lack meaningful details such as interest charges, cashflow statements and balance sheets. Why are the Exchange's results delayed?</div>

<h2 class="center">Results Delayed<br>
<span class="headlinedate">30 September 1999</span></h2>
<p>Look at your newspapers today and you will find a
...
For the more detailed audited annual results, they are allowed 5 months. </p>

<p>Some of the worst company results are released at the latest
...
<p>That's no way to run a &quot;wannabe&quot; global financial
...
the idea of quarterly reporting. You can read the
<a target="_blank" href="../codocs/SEHK981211pr.pdf">announcement</a>
or the 
<a target="_blank" href="http://www.hkex.com.hk/consul/paper/conpaper2.htm">consultation
paper</a> on their web site. </p>

<p><i>Webb-site.com </i> made a submission on these proposals on
17-Jan-99 which was
generally supportive. A copy can be found <a href="findoscons.asp" target="_blank">here</a>.&nbsp;The
...
comment on the delay. </p>

<h3>GEM Disclosure will be weak too</h3>

<p>The soon to be launched GEM market has separate listing rules
...
rules (45 days and 90 days respectively). </p>

<p>However, the GEM rules do not implement many of the other
...
<p>The delay in releasing the results of the consultation and
...
be meaningless soon after they are published. </p>

<p>We have to wonder to what extent this regulatory role will take
...
<hr>
		...
		<ul>
				...
				<li><a href="/dbpub/subject.asp?c=179">Reporting speed</a></li>
