...
<script type="text/javascript">document.title="Wharf voting advice";</script>

	<div class="summary">The 22nd AGM in Project Poll, and we urge investors to vote against the issue mandate. After all, we don't mandate boards to buy back shares from chosen shareholders at a premium to market price, so why should they be allowed to issue shares to chosen shareholders at a discount?</div>

<h2 class="center">Wharf voting advice<br>
<span class="headlinedate">20 May 2003</span></h2>
  <table class="txtable">
    <tr>
      <td>Company:</td>
      <td>The Wharf (Holdings) Limited (<b>Wharf</b>)</td>
    </tr>
    <tr>
      <td>Stock code:</td>
      <td>0004</td>
    ...
    <tr>
      ...
      <td>
      <a target="_blank" href="http://www.hkexnews.hk/listedco/listconews/sehk/20030502/LTN20030502083.pdf">Click
        here</a></td>
    </tr>
    <tr>
      <td>Voting method:</td>
...
us</a> if you want one.</b></p>
  ...
  <table class="txtable">
    ...
    <tr>
      <td>3</td>
      <td>Re-elect Edward Chen Kwan Yiu</td>
      <td>FOR</td>
    </tr>
    <tr>
      <td></td>
    ...
    <tr>
      <td></td>
      <td>Re-elect Erik B Christensen</td>
      <td>FOR</td>
    </tr>
    <tr>
      <td></td>
      <td>Re-elect Vincent K Fang</td>
      <td>FOR</td>
    </tr>
    <tr>
      <td></td>
      <td>Re-elect Quinn Law Yee Kwan</td>
      <td>FOR</td>
    </tr>
    <tr>
      <td></td>
      <td>Re-elect Doreen Y F Lee </td>
      <td>FOR</td>
    </tr>
    <tr>
      <td>4</td>
