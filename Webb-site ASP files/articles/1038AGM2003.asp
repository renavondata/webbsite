...
<script type="text/javascript">document.title="CKI Voting Recommendations";</script>

	<div class="summary">The 14th AGM in Project Poll is on 15-May-03. We urge shareowners to vote against the general mandate, which could enlarge the free float by 133% if fully used, likely necessitating a substantial discount.</div>

<h2 class="center">CKI Voting Recommendations<br>
<span class="headlinedate">5 May 2003</span></h2>
<table class="txtable">
    <tr>
      <td>Company:</td>
      <td>Cheung Kong Infrastructure Holdings Limited (<b>CKI</b>)</td>
    </tr>
    <tr>
      <td>Stock code:</td>
      <td>1038</td>
    ...
    <tr>
      ...
      <td>
      <a target="_blank" href="http://www.hkexnews.hk/listedco/listconews/sehk/20030331/1038/f120.pdf">Click
        here</a></td>
    </tr>
    <tr>
      <td>Voting method:</td>
...
us</a> if you want one.</b></p>
  ...
  <table class="txtable">
    ...
    <tr>
      <td>3</td>
      <td>Re-elect Eric Kwan Bing Sing</td>
      <td>FOR</td>
    </tr>
    <tr>
      <td></td>
      <td>Re-elect Tso Kai Sum</td>
      <td>FOR</td>
    </tr>
    <tr>
      <td></td>
      <td>Re-elect Barrie Cook</td>
      <td>FOR</td>
    </tr>
    <tr>
      <td>4</td>
...
<p>It is worth noting that since CKI is about 85% owned by Hutchison Whampoa Ltd 
(0013), in the event of a full 20% placing, the free float would be increased by 
a massive 133%. That would require quite a discount, and if you are an existing 
shareholder, you may not be offered any.</p>
