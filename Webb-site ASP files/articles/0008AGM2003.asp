...
<script type="text/javascript">document.title="PCCW voting advice";</script>

	<div class="summary">The 15th AGM in Project Poll is on 22-May-03. We urge shareowners to protect their investment by voting against the general mandate.</div>

<h2 class="center">PCCW voting advice<br>
<span class="headlinedate">9 May 2003</span></h2>
  <table class="txtable">
    <tr>
      <td>Company:</td>
      <td>PCCW Limited (<b>PCCW</b>)</td>
    </tr>
    <tr>
      <td>Stock code:</td>
      <td>0008</td>
    ...
    <tr>
      ...
      <td>
      <a target="_blank" href="http://www.hkexnews.hk/listedco/listconews/sehk/20030416/LTN20030416124.pdf">Click
        here</a></td>
    </tr>
    <tr>
      <td>Voting method:</td>
...
us</a> if you want one.</b></p>
  <table class="txtable">
    ...
    <tr>
      <td>2.a</td>
      <td>Re-elect Peter Anthony Allen</td>
      <td>FOR</td>
    </tr>
    <tr>
      <td>2.b</td>
      <td>Re-elect John Todd Bonner</td>
      <td>FOR</td>
    </tr>
    <tr>
      <td>2.c</td>
      <td>Re-elect Michael John Butcher</td>
      <td>FOR</td>
    </tr>
    <tr>
      <td>2.d</td>
      <td>Re-elect Mico Chung Cho Yee</td>
      <td>FOR</td>
    </tr>
    <tr>
      <td>2.e</td>
      <td>Re-elect David Ford</td>
      <td>FOR</td>
    </tr>
    <tr>
      <td>2.f</td>
      <td>Re-elect Robert Lee Chi Hong</td>
      <td>FOR</td>
    </tr>
    <tr>
      <td>2.g</td>
      <td>Re-elect Francis Yuen Tin Fan</td>
      <td>FOR</td>
    </tr>
    <tr>
      <td>2.h</td>
      <td>Authorise the directors to fix their own 
      remuneration (<b>see comment</b>)</td>
      <td>FOR</td>
    </tr>
    <tr>
      <td>3</td>
...
<p>This resolution only relates to the remuneration of individuals <i>as 
directors </i>and not as employees, so for executive directors, it does not 
relate to their salary, bonus and other benefits, which are not subject to 
shareholder approval.</p>

<p>Other companies, including <a target="_blank" href="0003agm2003.asp">Hong 
Kong and China Gas</a> and <a href="0388agm2003.asp">Hong Kong Exchanges and 
Clearing</a>, have been more progressive in this area by specifying a dollar 
amount of director's fee to be approved by shareholders. We urge PCCW to follow 
this example next year.</p>
