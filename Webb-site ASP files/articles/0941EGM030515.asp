...
<script type="text/javascript">document.title="China Mobile EGM";</script>

	<div class="summary">Right after the AGM on 15-May-03, there's an EGM to approve ongoing connected transactions.</div>

<h2 class="center">China Mobile EGM<br>
...
<table class="txtable">
    ...
    <tr>
      ...
      <td>
      <a target="_blank" href="http://www.hkexnews.hk/listedco/listconews/sehk/20030415/LTN20030415065.pdf">Click
        here</a></td>
    </tr>
    <tr>
      <td>Voting method:</td>
...
<table class="txtable">
    ...
    <tr>
      <td>1</td>
      <td>Approve ongoing connected transactions for 
      prepaid services and platform development</td>
      <td>FOR</td>
    </tr>
</table>
