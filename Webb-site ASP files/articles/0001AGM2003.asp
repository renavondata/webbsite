...
<script type="text/javascript">document.title="Cheung Kong Voting Advice";</script>

	<div class="summary">The 17th AGM in Project Poll is on 22-May-03. We urge shareowners to protect their investment by voting against the general mandate.</div>

<h2 class="center">Cheung Kong Voting Advice<br>
<span class="headlinedate">9 May 2003</span></h2>
  <table class="txtable">
    <tr>
      <td>Company:</td>
      <td>Cheung Kong (Holdings) Limited (<b>CKH</b>)</td>
    </tr>
    <tr>
      <td>Stock code:</td>
      <td>0001</td>
...
of Meeting: </p>
      ...
      <td>
      <a target="_blank" href="http://www.hkexnews.hk/listedco/listconews/sehk/20030407/0001/f124.pdf">Click
        here</a></td>
    </tr>
    <tr>
      <td>Voting method:</td>
...
us</a> if you want one.</b></p>
  ...
  <table class="txtable center">
    ...
    <tr>
      <td>3</td>
      <td>Re-elect George Colin Magnus</td>
      <td>FOR</td>
    </tr>
    <tr>
      <td></td>
      <td>Re-elect Kam Hing Lam</td>
      <td>FOR</td>
    </tr>
    <tr>
      <td></td>
      <td>Re-elect Canning Fok Kin-ning</td>
      <td>FOR</td>
    </tr>
    <tr>
      <td></td>
      <td>Re-elect Frank John Sixt</td>
      <td>FOR</td>
    </tr>
    <tr>
      <td></td>
      <td>Re-elect Katherine Hung Siu-lin</td>
      <td>FOR</td>
    </tr>
    <tr>
      <td></td>
      <td>Re-elect Stanley Kwok Tun-li</td>
      <td>FOR</td>
    </tr>
    <tr>
      <td>4</td>
