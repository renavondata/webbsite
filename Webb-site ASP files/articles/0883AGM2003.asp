...
<script type="text/javascript">document.title="CNOOC voting advice";</script>

	<div class="summary">The 20th AGM in Projects Poll and Vampire, and we urge investors to vote against the issue mandate, to help protect their investment from dilution.</div>

<h2 class="center">CNOOC voting advice<br>
...
<table class="txtable">
    ...
    <tr>
      ...
      <td>
      <a target="_blank" href="http://www.hkexnews.hk/listedco/listconews/sehk/20030414/0883/f121.pdf">Click
        here</a></td>
    </tr>
    <tr>
      <td>Voting method:</td>
...
us</a> if you want one.</b></p>
  ...
  <table class="txtable">
    ...
    <tr>
      <td>3.1</td>
      <td>Re-elect Jiang Longsheng</td>
      <td>FOR</td>
    </tr>
    <tr>
      <td>3.2</td>
      <td>Re-elect Luo Han</td>
      <td>FOR</td>
    </tr>
    <tr>
      <td>3.3</td>
      <td>Re-elect Chiu Sung Hong</td>
      <td>FOR</td>
    </tr>
    <tr>
      <td>4</td>
    ...
    <tr>
      <td>8</td>
      <td>Authorise the directors to fix the 
      remuneration of the members of any committee</td>
      <td>FOR</td>
    </tr>
    </table>
