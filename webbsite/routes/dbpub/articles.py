...
def articles():
    ...
    return redirect(
        "https://web.archive.org/web/2/https://webb-site.com/dbpub/articles.asp"
...
def articles_year():
    ...
    return redirect(
        "https://web.archive.org/web/2/https://webb-site.com/dbpub/articlesyear.asp"
...
def artlinks():
    ...
    return redirect(
        "https://web.archive.org/web/2/https://webb-site.com/dbpub/artlinks.asp"
...
def subject():
    ...
    return redirect(
        "https://web.archive.org/web/2/https://webb-site.com/dbpub/subject.asp"
