...
def reset():
    ...
    if request.method == 'POST':
        # TODO: Reset password
        return render_template('webbmail/reset.html',
                             message="Password reset not yet implemented")
...
def ratinghist():
    ...
    return render_template('webbmail/ratinghist.html',
                         person_id=person_id, ratings=[])
...
def mailpref():
    ...
    if request.method == 'POST':
        ...
        return render_template('webbmail/mailpref.html',
                             message="Preferences not yet implemented")
    # TODO: Check authentication
