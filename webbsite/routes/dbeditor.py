...
def org():
    ...
    if request.method == "POST":
        ...
        return render_template(
            "dbeditor/org.html", person_id=person_id, message="Save not yet implemented"
        )
...
def combineorgs():
    ...
    if request.method == "POST":
        ...
        return render_template(
            "dbeditor/combineorgs.html", message="Merge not yet implemented"
        )
...
def combineppl():
    ...
    if request.method == "POST":
        # TODO: Merge people
        return render_template(
            "dbeditor/combineppl.html", message="Merge not yet implemented"
        )
...
def officer():
    ...
    if request.method == "POST":
        ...
        return render_template(
            "dbeditor/officer.html", dir_id=dir_id, message="Save not yet implemented"
        )
...
def issue():
    ...
    if request.method == "POST":
        # TODO: Save issue
        return render_template(
            "dbeditor/issue.html", issue_id=issue_id, message="Save not yet implemented"
        )
...
def pay():
    ...
    if request.method == "POST":
        ...
        return render_template(
            "dbeditor/pay.html", pay_id=pay_id, message="Save not yet implemented"
        )
...
def holdinghist():
    ...
    return render_template(
        "dbeditor/holdinghist.html", person_id=person_id, holdings=[]
    )
...
def coms():
    ...
    if request.method == "POST":
        # TODO: Save committee
        return render_template(
            "dbeditor/coms.html", com_id=com_id, message="Save not yet implemented"
        )
...
def comattend():
    ...
    return render_template(
        "dbeditor/comattend.html", person_id=person_id, attendance=[]
    )
...
def story():
    ...
    if request.method == "POST":
        # TODO: Save story
        return render_template(
            "dbeditor/story.html", story_id=story_id, message="Save not yet implemented"
        )
...
def docedit():
    ...
    if request.method == "POST":
        # TODO: Save document
        return render_template(
            "dbeditor/docedit.html", doc_id=doc_id, message="Save not yet implemented"
        )
...
def web():
    ...
    if request.method == "POST":
        # TODO: Save website
        return render_template(
            "dbeditor/web.html", person_id=person_id, message="Save not yet implemented"
        )
    # TODO: Load websites
...
def classifications():
    ...
    return render_template(
        "dbeditor/classifications.html", person_id=person_id, classes=[]
    )
...
def useradmin():
    ...
    if request.method == "POST":
        ...
        return render_template(
            "dbeditor/useradmin.html", message="User admin not yet implemented"
        )
