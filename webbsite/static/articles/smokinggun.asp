...
<script type="text/javascript">document.title="Smoking Gun";</script>

	<div class="summary">Webb-site.com has obtained a letter which provides an exclusive look at Legislator Henry Wu's anti-competitive attempt to maintain the brokerage cartel's fixed commission rates. In other jurisdictions, this kind of collusion and price-fixing would be illegal. Hong Kong badly needs a competition law.</div>

<h2 class="center">Smoking Gun<br>
<span class="headlinedate">5 November 2001</span></h2>
<p><i>Webb-site.com</i> has obtained a letter which provides an
exclusive look at the last-ditch efforts of the brokerage
sector to head off competition. Legislator <a href="http://www.legco.gov.hk/general/english/members/yr00-04/wkc.htm" target="_blank"> Henry Wu
King-cheong</a>, who holds the
...
acrobat format, <a href="../codocs/henrywuletter.pdf" target="_blank">click here</a>. </p>

<p>This letter is reminiscent of the Law Society's failed attempt
not so long ago to fix tender rates for the handling of government property
transactions. </p>

<p>The minimum commission rate of 0.25% is currently set by the
Stock Exchange of Hong Kong Ltd, which has a legally-protected monopoly on the
operation of a stock exchange in Hong Kong. <a href="http://www.hkex.com.hk/rulereg/rulesex/chap-5_eng.doc" target="_blank">Rule
534</a> sets the limit. </p>

<p>Mr Wu's letter says the cartel has reached a <i>&quot;consensus
that the Authorities should adopt a two-tier brokerage commission system&quot;</i>
in which commissions on large transactions would be negotiable but those below a
certain value or &quot;Line&quot; would be subject to the cartel rate. </p>

<p>In order to set a <i>&quot;reasonable specific invoice
amount&quot;</i> (reasonable, that is, if you are a broker, but extortionate if
...
fixed and negotiable rates. </p>

<p>The tick-boxes start at $0.25m and go up in steps of
the same amount to $2m. Notably, there is no tick-box for &quot;zero&quot;. In
Mr Wu's book, full competition is <i>not</i> an option. At the mid-point of the line, they
...
the phone and pressing a few buttons. </p>

<p>In most developed economies, there exist laws against such
...
which is holding back the economic recovery. </p>

<p>To be fair to Mr Wu, he is only arguing the case for the
...
of them small. To <a href="http://www.info.gov.hk/reo/doc/fs2.doc" target="_blank">vote</a>,
you have to be a Stock Exchange or Futures Exchange brokerage, or a member of <a href="http://www.cgse.com.hk/member.htm" target="_blank">The
Chinese Gold &amp; Silver Exchange Society</a>, membership of which is capped at
192. </p>

<p>The internet was not invented yesterday, and nor was electronic
...
from the flotation of HKEx. </p>

<p>Now they are tugging at the economic heartstrings and arguing
...
should have protection from the free market. </p>
...
<hr>
		...
		<ul>
				...
				<li><a href="/dbpub/natarts.asp?p=1093">Wu, Henry King Cheong</a></li>
