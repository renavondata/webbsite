...
<script type="text/javascript">document.title="Wheelock voting advice";</script>

	<div class="summary">The next HSI member to hold its AGM is Wheelock. We urge investors to vote against the placing mandate, which does not comply with the recommendations of Project Vampire. Time is short, so VOTE NOW.</div>

<h2 class="center">Wheelock voting advice<br>
<span class="headlinedate">10 August 2003</span></h2>
  <table class="txtable">
    <tr>
      <td>Company:</td>
      <td>Wheelock and Company Limited (<b>Wheelock</b>)</td>
    </tr>
    <tr>
      <td>Stock code:</td>
      <td>0020</td>
    ...
    <tr>
      ...
      <td>15-Aug-03 <span style="color:red"><b>VOTE NOW</b></span></td>
    </tr>
    <tr>
      <td>Notice of Meeting:</td>
      <td>
      <a target="_blank" href="http://www.hkexnews.hk/listedco/listconews/sehk/20030728/LTN20030728077.pdf">Click
        here</a></td>
    </tr>
    <tr>
      <td>Voting method:</td>
...
us</a> if you want one.</b></p>
  ...
  <table class="txtable">
    ...
    <tr>
      <td>3(a)</td>
      <td>Re-elect Alexander Au Siu-kee</td>
      <td>FOR</td>
    </tr>
    <tr>
      <td>3(b)</td>
      <td>Re-elect William Turnbull</td>
      <td>FOR</td>
    </tr>
    <tr>
      <td>4</td>
