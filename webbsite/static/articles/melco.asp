...
<script type="text/javascript">document.title="Melco's floating Merchants";</script>

	<div class="summary">Shares in Melco International Development, operator of the Jumbo floating restaurants, were up 285% today on the back of a proposed acquisition of respected e-commerce developer iMerchants. Only problem is, we don't think the deal will ever happen...</div>

<h2 class="center">Melco's floating Merchants<br>
<span class="headlinedate">7 December 1999</span></h2>
<p>Shares in Melco International Development Ltd (<b>Melco</b>)
...
respected e-commerce developer <a href="http://www.imerchants.com/">iMerchants</a>
Group. Melco is better known as the owner-operator of the Jumbo floating restaurants
in Aberdeen, Hong Kong. </p>

<p>The shares closed up a whopping 285% at $3.85. The only problem
...
Substantial Acquisition&quot; or <b>VSA </b>and would be treaded as a new
...
is upheld then the deal will not proceed. </p>

<p>The reason for this condition is that, if the deal were treated
...
announcement admits that &quot;<i>the businesses which will be injected...have
not previously operated as an integrated group of companies.</i>&quot; It
continues &quot;<i>Exploration Enterprises therefore has no historic financial
statements</i>&quot;. No doubt the individual component businesses of iMerchants
have some sort of accounts, but it would take a lot of time to compile and audit
them into group accounts. </p>

<p>Finally, even if the 3-year track record is available, the
...
of $1.4m so that doesn't help either. </p>

<h3>Backdoor Listing Rules at Stake </h3>

<p>The SEHK faces a crucial test here. If they allow the deal
...
<p>Perhaps the only way out of this would be for Melco to apply for
a listing down on GEM. But in that case, surely iMerchants would rather go it
alone than tie up with a floating restaurant business? </p>

<p>Interestingly, 3 weeks ago on 10-Nov-99 Melco announced that it
was &quot;<i>considering two proposals regarding a possible disposal of assets
which are surplus to its operational needs and an acquisition of assets by the
Company in relation to its core business.</i>&quot; </p>

<p>It is not clear whether one of these transactions was the
...
509 car park spaces at the Jumbo Court Public Carpark, 3 Welfare Road, Aberdeen. </p>
